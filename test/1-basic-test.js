...
describe("XLSX_CALC", function () {
  ...
  describe("ROUND", () => {
    ...
    it("should round to 1.2", () => {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 1.2);
    });
  });
  ...
  describe("plus", function () {
    it("should calc A2+C5", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 10);
    });
  ...
  describe("minus", function () {
    ...
    it("should calc -2-3-4", function () {
      workbook.Sheets.Sheet1.A1.f = "-2-3-4";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, -9);
    });
  });
  describe("multiply", function () {
    it("should calc A2*C5", function () {
      workbook.Sheets.Sheet1.A1.f = "A2*C5";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 21);
    });
    it("should calc A2*4", function () {
      workbook.Sheets.Sheet1.A1.f = "A2*4";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 28);
    });
  ...
  describe("divide", function () {
    it("should calc A2/C4", function () {
      workbook.Sheets.Sheet1.A1.f = "A2/C4";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 3.5);
    });
    it("should calc A2/14", function () {
      workbook.Sheets.Sheet1.A1.f = "A2/14";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 0.5);
    });
    it("should calc 7/2/2", function () {
      workbook.Sheets.Sheet1.A1.f = "7/2/2";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 1.75);
    });
  ...
  describe("power", function () {
    it("should calc 2^10", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 1024);
    });
  });
  ...
  describe("FLOOR", function () {
    it("should calc FLOOR(12.5)", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 12);
    });
  });
  describe(".set_fx", function () {
    it("sets new function", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 124);
    });
  });
  describe("expression", function () {
    ...
    it("should calc 2*(3-1)", function () {
      workbook.Sheets.Sheet1.A1.f = "2*(3-1)";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 4);
    });
    ...
    it("should calc (3*10)-(2-1)", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 29);
    });
    it("should calc (3*10)-(2-(3*5))", function () {
      workbook.Sheets.Sheet1.A1.f = "(3*10)-(2-(3*5))";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 43);
    });
    it("should calc (3*10)-(-2-(3*5))", function () {
      workbook.Sheets.Sheet1.A1.f = "(3*10)-(-2-(3*5))";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 47);
    });
    it("should calc 8/2*10", function () {
      workbook.Sheets.Sheet1.A1.f = "8/2*10";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 40);
    });
  });
  ...
  describe("MAX and SUM", function () {
    it("evaluates MAX(1,2,SUM(10,5),7,3,4)", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 15);
    });
    it("evaluates MAX(1,2, SUM(10,5),7,3,4)", function () {
      workbook.Sheets.Sheet1.A1.f = "MAX(1,2, SUM(10,5),7,3,4)";
      XLSX_CALC(workbook);
  ...
  describe("&", function () {
    it('evaluates "concat "&A2', function () {
      ...
      workbook.Sheets.Sheet1.A2.v = 7;
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "concat 7");
    });
    it('evaluates "concat +1" & A2', function () {
      workbook.Sheets.Sheet1.A1.f = '"concat +1" & A2';
      workbook.Sheets.Sheet1.A2.v = 7;
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "concat +17");
    });
    it('evaluates A2 & "concat"', function () {
      workbook.Sheets.Sheet1.A1.f = 'A2 & "concat +1"';
      workbook.Sheets.Sheet1.A2.v = 7;
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "7concat +1");
    });
  });
  describe("CONCATENATE", function () {
    ...
    it("concatenates null and undefined values as empty", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "79---tutu");
    });
  });
  describe("range", function () {
    it("should eval the expression in range of sum", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 8);
      assert.strictEqual(workbook.Sheets.Sheet1.C4.v, 7);
    });
    ...
    it("A1:A3 formula should return #VALUE! error", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.B1.t, "e");
      assert.strictEqual(workbook.Sheets.Sheet1.B1.v, errorValues["#VALUE!"]);
      assert.strictEqual(workbook.Sheets.Sheet1.B1.w, "#VALUE!");
    });
    it("should preserve error state when a cell is in error", function () {
      ...
      var expected = [[{ t: "e", v: 42, w: "#N/A" }], [1], [2]];
  ...
  describe("boolean", function () {
    it("evaluates 1<2 as true", function () {
      workbook.Sheets.Sheet1.A1.f = "1<2";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, true);
    });
    it("evaluates 1>2 as false", function () {
      workbook.Sheets.Sheet1.A1.f = "1>2";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, false);
    });
    ...
    it('evaluates undefined<>"" as false', function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, false);
    });
    it('evaluates undefined="" as true', function () {
      workbook.Sheets.Sheet1.A2.f = 'A1=""';
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, true);
    });
  ...
  describe("dates", function () {
    it("dateA - dateB should calc day diff", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A3.v, 5);
      assert.strictEqual(workbook.Sheets.Sheet1.A3.t, "n");
    });
    it("DateA + 5 should add 5 days to dateA", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "n");
      assert.strictEqual(
        workbook.Sheets.Sheet1.A2.v,
        Date.parse(new Date("2019-01-15"))
      );
    });
    it("< operator should work for dates", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A4.v, true);
      assert.strictEqual(workbook.Sheets.Sheet1.A5.v, false);
      assert.strictEqual(workbook.Sheets.Sheet1.A6.v, false);
    });
    it("> operator should work for dates", function () {
      workbook.Sheets.Sheet1.A1 = {
        t: "d",
    ...
    it("= operator should work for dates", function () {
      ...
      workbook.Sheets.Sheet1.A5 = { f: "A1 = A3" };
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A4.v, false);
      assert.strictEqual(workbook.Sheets.Sheet1.A5.v, true);
    });
    ...
    it("date + TIME(0, integer, 0) should return a date with increased minutes", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.B1.t, "n");
      assert.strictEqual(
        workbook.Sheets.Sheet1.B1.v,
        Date.parse(new Date("2019-02-18 08:30"))
      );
    });
    xit("MIN, MAX should work for dates", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A4.v instanceof Date, true);
      assert.strictEqual(workbook.Sheets.Sheet1.A4.v.getTime(), 1547251200000);
      assert.strictEqual(workbook.Sheets.Sheet1.A5.v instanceof Date, true);
      assert.strictEqual(workbook.Sheets.Sheet1.A5.v.getTime(), 1547078400000);
    });
  });
  describe("SUBSTITUTE", function () {
    it("should throw #VALUE if occurence value is 0", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.w, "#VALUE!");
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, errorValues["#VALUE!"]);
    });
    ...
    it("should transform Jim to James", function () {
      workbook.Sheets.Sheet1.A1 = {
        f: 'SUBSTITUTE("Jim Alateras","im","ames")',
      };
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "James Alateras");
    });
    it("should transform nothing", function () {
      workbook.Sheets.Sheet1.A1 = { f: 'SUBSTITUTE("Jim Alateras","","ames")' };
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "Jim Alateras");
    });
    it("should equals empty string", function () {
      workbook.Sheets.Sheet1.A1 = { f: 'SUBSTITUTE("","im","ames")' };
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "");
    });
    it("should equal Quarter 2, 2008", function () {
      workbook.Sheets.Sheet1.A1 = {
        f: 'SUBSTITUTE("Quarter 1, 2008","1","2", 1)',
      };
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "Quarter 2, 2008");
    });
    it("should equal 07792 526879", function () {
      workbook.Sheets.Sheet1.A1 = { f: 'SUBSTITUTE("t:07792 526879","t:","")' };
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "07792 526879");
    });
    it("should handle especial chars like dot", function () {
      workbook.Sheets.Sheet1.A1 = { f: 'SUBSTITUTE("my text","...","")' };
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "my text");
    });
  });
  describe("DAY", function () {
    xit("should return day of date value", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, 29);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "n");
    });
    it("should throw #VALUE error if applied to an invalid date", function () {
      ...
      workbook.Sheets.Sheet1.A2 = { f: "DAY(A1)" };
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "e");
      assert.strictEqual(workbook.Sheets.Sheet1.A2.w, "#VALUE!");
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, errorValues["#VALUE!"]);
    });
  });
  describe("MONTH", function () {
    it("should return month of date value", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, 5);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "n");
    });
    it("should throw #VALUE error if applied to an invalid date", function () {
      workbook.Sheets.Sheet1.A1 = { v: "AAA" };
  ...
  describe("YEAR", function () {
    it("should return year of date value", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, 2019);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "n");
    });
    it("should throw #VALUE error if applied to an invalid date", function () {
      workbook.Sheets.Sheet1.A1 = { v: "AAA" };
  ...
  describe("RIGHT", function () {
    it("should return n last characters of a string value", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, "ue");
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "s");
    });
    it("should return n last characters of a numeric value", function () {
      ...
      workbook.Sheets.Sheet1.A2.f = "RIGHT(A1, 2)";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, "19");
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "s");
    });
    it("should work in combination with YEAR formula", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.C1.v, "19");
      assert.strictEqual(workbook.Sheets.Sheet1.C1.t, "s");
    });
  ...
  describe("LEFT", function () {
    it("should return n first characters of a string value", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, "te");
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "s");
    });
    it("should return n first characters of a numeric value", function () {
      ...
      workbook.Sheets.Sheet1.A2.f = "LEFT(A1, 2)";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, "20");
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "s");
    });
    it("should work in combination with YEAR formula", function () {
      workbook.Sheets.Sheet1.A1 = {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.C1.v, "20");
      assert.strictEqual(workbook.Sheets.Sheet1.C1.t, "s");
    });
    it("should throw a #VALUE! error when used with an incorrect nb_car parameter", function () {
      workbook.Sheets.Sheet1.A1.v = "test value";
  ...
  it("calcs ref with space", function () {
    ...
    XLSX_CALC(workbook);
    assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 1979);
  });
  ...
  it("calcs ref chain", function () {
    ...
    workbook.Sheets.Sheet1.A2.v = 1979;
    XLSX_CALC(workbook);
    assert.strictEqual(workbook.Sheets.Sheet1.C4.v, 1979);
  });
  ...
  it("handles error values", function () {
    ...
    XLSX_CALC(workbook);
    assert.strictEqual(workbook.Sheets.Sheet1.A1.v, errorValues["#DIV/0!"]);
    assert.strictEqual(workbook.Sheets.Sheet1.A1.w, "#DIV/0!");
    assert.strictEqual(workbook.Sheets.Sheet1.A1.t, "e");
  });
  it("propagates error values", function () {
    ...
    XLSX_CALC(workbook);
    assert.strictEqual(workbook.Sheets.Sheet1.A2.v, errorValues["#N/A"]);
    assert.strictEqual(workbook.Sheets.Sheet1.A2.w, "#N/A");
    assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "e");
    ...
    XLSX_CALC(workbook);
    assert.strictEqual(workbook.Sheets.Sheet1.B2.v, errorValues["#DIV/0!"]);
    assert.strictEqual(workbook.Sheets.Sheet1.B2.w, "#DIV/0!");
    assert.strictEqual(workbook.Sheets.Sheet1.B2.t, "e");
  });
  describe("PTM", function () {
    it("calcs PMT(0.07/12, 24, 1000)", function () {
      workbook.Sheets.Sheet1.A1.f = "PMT(0.07/12, 24, 1000)";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, -44.77257910314528);
    });
    it("calcs PMT(0.07/12, 24, 1000,2000,0)", function () {
      workbook.Sheets.Sheet1.A1.f = "PMT(0.07/12, 24, 1000,2000,0)";
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, -122.6510706427692);
    });
  });
  ...
  describe("NORM.INV", function () {
    it("should call normsInv", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, -0.030284938471650775);
    });
  });
  describe("STDEV", function () {
    it("should calc STDEV", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 0.962047667366703);
    });
  });
  describe("AVERAGE", function () {
    ...
    it("should calc AVERAGE of range", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A7.v, 0.25);
    });
    it("should calc AVERAGE of empty cells as div by zero", function () {
      workbook.Sheets.Sheet1 = {};
      workbook.Sheets.Sheet1.B1 = { f: "AVERAGE(A1:A6)" };
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.B1.v, errorValues["#DIV/0!"]);
      assert.strictEqual(workbook.Sheets.Sheet1.B1.w, "#DIV/0!");
      assert.strictEqual(workbook.Sheets.Sheet1.B1.t, "e");
    });
  });
  describe("IRR", function () {
    it("calcs IRR", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, -0.5091672986745834);
    });
    it("calcs IRR 2", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 30.672816276550293);
    });
  });
  describe("VAR.P", function () {
    it("calcs VAR.P", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A7.v.toFixed(8), 0.01583333);
    });
    it("calls the VAR.P", function () {
      var x = XLSX_CALC.exec_fx("VAR.P", [0.1, 0.5, 0.2, 0.3, 0.2, 0.2]);
      assert.strictEqual(x.toFixed(8), 0.01583333);
    });
  });
  describe("COVARIANCE.P", function () {
    it("computes COVARIANCE.P", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A7.v.toFixed(8), 0.00158333);
    });
  });
  describe("#int_2_col_str", function () {
    it("should returns A", function () {
      assert.strictEqual(XLSX_CALC.int_2_col_str(0), "A");
    });
    it("should returns B", function () {
      assert.strictEqual(XLSX_CALC.int_2_col_str(1), "B");
    });
    it("should returns AZ", function () {
      assert.strictEqual(XLSX_CALC.int_2_col_str(51), "AZ");
    });
    it("should returns BA", function () {
      assert.strictEqual(XLSX_CALC.int_2_col_str(52), "BA");
    });
  });
  describe("EXP", function () {
    it("calculates EXP", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 7.3890560989306495);
    });
  });
  ...
  describe("ISBLANK", function () {
    ...
    it("calculates ISBLANK as false for a ref to an error cell", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.B1.v, false);
    });
  });
  ...
  describe('Cell type: A2.t = "s" or A2.t = "n"', function () {
    it('should set t = "s" for string values', function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "s");
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, "some string");
    });
    it('should set t = "n" for numeric values', function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "n");
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, 11);
    });
  });
  ...
  describe("IFERROR", function () {
    it("returns the string Error", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "Error");
    });
    ...
    it("returns the string boston", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "boston");
    });
    ...
    it("returns the string Error when in reference to an error cell", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A2.v, "Error");
      assert.strictEqual(workbook.Sheets.Sheet1.A2.t, "s");
    });
  ...
  describe("HLOOKUP", function () {
    it("searches for a key in the top row of a matrix and returns the value in the same column at the specified return_index row", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.D1.v, 7);
    });
    it("returns #N/A error when used with an empty needle", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.C1.t, "e");
      assert.strictEqual(workbook.Sheets.Sheet1.C1.v, 42);
      assert.strictEqual(workbook.Sheets.Sheet1.C1.w, "#N/A");
    });
  });
  ...
  describe("VLOOKUP", function () {
    it("exact match", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.D2.v, 1995);
    });
    it("approximate match", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.B1.v, 4);
      assert.strictEqual(workbook.Sheets.Sheet1.B2.v, 2);
      assert.strictEqual(workbook.Sheets.Sheet1.B3.v, 4);
      assert.strictEqual(workbook.Sheets.Sheet1.B4.v, 3);
      assert.strictEqual(workbook.Sheets.Sheet1.B5.v, 2);
      assert.strictEqual(workbook.Sheets.Sheet1.B6.v, 3);
      assert.strictEqual(workbook.Sheets.Sheet1.B7.v, 4);
      assert.strictEqual(workbook.Sheets.Sheet1.B8.v, 6);
    });
  });
  ...
  describe("INDEX", function () {
    it("returns the value of an element in a matrix, selected by the row and column number indexes", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.C1.v, "Pears");
      assert.strictEqual(workbook.Sheets.Sheet1.C2.v, "Bananas");
    });
  });
  ...
  describe("MATCH_GREATER_THAN_OR_EQUAL", function () {
    it("return position of element in range (row or column)", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.B4.v, 2);
      assert.strictEqual(workbook.Sheets.Sheet1.B5.v, 3);
      assert.strictEqual(workbook.Sheets.Sheet1.C4.v, 2);
      assert.strictEqual(workbook.Sheets.Sheet1.C5.v, 3);
      assert.strictEqual(workbook.Sheets.Sheet1.D4.v, 1);
      assert.strictEqual(workbook.Sheets.Sheet1.D5.v, 3);
      assert.strictEqual(workbook.Sheets.Sheet1.C6.v, 2);
      assert.strictEqual(workbook.Sheets.Sheet1.C7.v, 3);
      assert.strictEqual(workbook.Sheets.Sheet1.D6.v, 1);
      assert.strictEqual(workbook.Sheets.Sheet1.D7.v, 3);
    });
  });
  ...
  describe("MATCH", function () {
    it("returns position of element in range (row or column)", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.B3.v, 3);
      assert.strictEqual(workbook.Sheets.Sheet1.B4.v, 5);
    });
    it('should show "#N/A" error when a multi-dimensional array is passed', function () {
      ...
      assert.strictEqual(workbook.Sheets.Sheet1.A3.t, "e");
      assert.strictEqual(workbook.Sheets.Sheet1.A3.w, "#N/A");
      assert.strictEqual(workbook.Sheets.Sheet1.A3.v, errorValues["#N/A"]);
    });
  });
  ...
  describe("SUMPRODUCT", function () {
    it("Multiplies corresponding components in the given arrays, and returns the sum of those products", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.C1.v, 156);
    });
    it("should handle empty values in the given arrays", function () {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.C1.v, 54);
    });
    it('shows "#VALUE!" error value if the array arguments dont have the same dimensions', function () {
      ...
      assert.strictEqual(workbook.Sheets.Sheet1.C1.t, "e");
      assert.strictEqual(workbook.Sheets.Sheet1.C1.w, "#VALUE!");
      assert.strictEqual(workbook.Sheets.Sheet1.C1.v, errorValues["#VALUE!"]);
    });
  ...
  describe("AND", () => {
    it("evaluates false", () => {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "ok");
    });
    it("evaluates true", () => {
      workbook.Sheets.Sheet1 = {
  ...
  describe("localizeFunctions", () => {
    it("makes an alias to CONCATENATE", () => {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "Hello world");
    });
  });
  ...
  describe("IFS", () => {
    it("for every pair of values, returns the first value that resolves to true", () => {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "c");
    });
  });
  ...
  describe("CHOOSE", () => {
    it('evaluates an CHOOSE(2,"a","b","c") as true', () => {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, "b");
    });
  });
  ...
  describe("CEILING", () => {
    it("should ceiling to 150", () => {
      ...
      XLSX_CALC(workbook);
      assert.strictEqual(workbook.Sheets.Sheet1.A1.v, 150);
    });
  });
